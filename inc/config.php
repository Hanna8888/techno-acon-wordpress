<?php
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Header Settings', 'acorn' ),
        'id'               => 'header',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                ...
                'desc'     => __( 'Upload your logo', 'redux-framework-demo' ),
                'subtitle' => __( 'Recommended size 200px-200px', 'redux-framework-demo' ),
                'default'  => array( 'url' => '' ),
                //'hint'      => array(
                //    'title'     => 'Hint Title',
        ...
        Redux::setSection( $opt_name, array(
        'title'            => __( 'Footer Settings', 'acorn' ),
        'id'               => 'footer',
        'desc'             => __( 'Setting for footer', 'redux-framework-demo' ),
        'customizer_width' => '400px',
        'icon'             => 'el el-bell'
    ) );
 ...
 Redux::setSection( $opt_name, array(
        ...
        'subsection'       => true,
        'desc'             => __( 'This is Social Network area', 'redux-framework-demo' ),
        'icon'             => 'el el-adress-book',
        'fields'           => array(
            array(
                'id'       => 'opt-social-network',
                'type'     => 'sortable',
                'title'    => __( 'Enter you Socia Nnetwork url', 'redux-framework-demo' ),
                'subtitle' => __( 'You can Socia Nnetwork area subtitle', 'redux-framework-demo' ),
                'desc'     => __( 'This is Socia Nnetwork description area here', 'redux-framework-demo' ),
                'label'    => 'true',
                'options'    => array(
                    'Facebook'     => 'Enter your facebook url',
                    'Telegram'     => 'Enter your telegram url',
